            ...
            <div>
                <div class="flex space-x-4 items-center" href="#">
                    ...
                    <div class="flex flex-col">
                        <h3 class="font-medium">USER-6</h3>
...
export default {
    ...
    data() {
        return {
            ...
            messages: [
                {
                    text: 'Lorem, ipsum dolor sit amet c nemo totam. Expedita deleniti nulla, nobis dignissimos a omnis architecto repellat aperiam. Consequuntur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: '16/01/2022 12:13pm',
                    user: false,
                },
                {
                    text: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. In possimus ducimus itaque iusto molestias animi repellendus ad modi incidunt aut? Soluta autem magni corrupti commodi! Possimus perferendis repudiandae iusto nemo totam. Expedita delenntur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: true,
                },
                {
                    text: 'Lorem, ipsum dolor sit amet consectetur adipisicing . Consequuntur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: false,
                },
                {
                    text: 'Lorem, ipsum dolortur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: false,
                },
            ],
