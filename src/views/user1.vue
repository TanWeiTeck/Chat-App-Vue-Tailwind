...
export default {
    ...
    data() {
        return {
            ...
            messages: [
                {
                    text: 'Lorem,ias animi repellendus ad modi incidunt aut? Soluta autem magni corrupti commodi! Possimus perferendis repudiandae iusto nemo totam. Expedita deleniti nulla, nobis dignissimos a omnis architecto repellat aperiam. Consequuntur architecto t.',
                    time: '17/01/2022 2:13pm',
                    user: true,
                },
                {
                    offer: true,
