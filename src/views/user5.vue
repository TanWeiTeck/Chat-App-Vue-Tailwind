            ...
            <div>
                <div class="flex space-x-4 items-center" href="#">
                    ...
                    <div class="flex flex-col">
                        <h3 class="font-medium">USER-5</h3>
    ...
    data() {
        return {
            ...
            messages: [
                ...
                {
                    text: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. In possimus ducimus itaque iusto molestias animi repellendus ad modi ii nulla, nobis dignissimos a omnis architecto repellat aperiam. Consequuntur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: false,
                },
                {
                ...
                {
                    text: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. In possimus ducimus itaque iusto molestias animi repellendus ad m. Consequuntur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: true,
                },
                {
                    text: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit.cto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: false,
                },
                {
