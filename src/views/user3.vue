            ...
            <div>
                <div class="flex space-x-4 items-center" href="#">
                    ...
                    <div class="flex flex-col">
                        <h3 class="font-medium">USER-3</h3>
    ...
    data() {
        return {
            ...
            messages: [
                ...
                {
                    text: 'Lorem, ipsum dolor sit amet Expedita deleniti nulla, nobis dignissimos a omnis architecto repellat aperiamut.',
                    time: 'message time',
                    user: false,
                },
                {
                ...
                {
                    text: 'Lorem, ipsum dolor sit amet consecutem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: false,
                },
                {
                    text: 'Lorem, ipsodi incidunt aut? Soluta autem magni corrupti commodi! Possimus perferendis repudiandae iusto nemo totam. Expedita deleniti nulla, nobis dignissimos a omnis architecto repellat aperiam. Consequuntur architecto autem assumenda culpa voluptatibus vero, sit aut.',
                    time: 'message time',
                    user: true,
                },
            ],
